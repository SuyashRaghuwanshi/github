...
class CommitTreeCommand{
    ...
    execute(){
        const commitContentBuffer=Buffer.concat([
            ...
            Buffer.from(`author Suyash Raghuwanshi <suyashraghuwanshi322004@gmail.com> ${Date.now()}+0000\n`),
            Buffer.from(`committer Suyash Raghuwanshi <suyashraghuwanshi322004@gmail.com> ${Date.now()}+0000\n\n`),
